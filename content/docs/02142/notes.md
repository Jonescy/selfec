...
- 时间复杂度的表示方法有两种:
  ...
  <img src="../../static/img/02142/image-20200919215253372.jpg" alt="image-20200919215253372"  />
...
- 【例4－1】分别给出图4－11a的二叉树先序遍历、中序遍历、后序遍历三种访问方式的结点访问序列。
  　　![img](../../../static/img/02142/wps95E.tmp.jpg)
    　　图4－11 二叉树及其划分
    　　a) 二叉树　b) 二叉树划分
...
- 所谓二叉树的层次遍历, 是指从二叉树的根结点的这一层开始, 逐层向下遍历, 在每一层上按从左到右的顺序对结点逐个访问。
  　　![img](../../../static/img/02142/wpsC0A4.tmp.jpg)
...
1. 孩子链表表示法
   　　孩子链表表示法是树的一种链式存储结构。它的主体是一个数组元素个数和树中结点个数相同的一维数组。树上的一个结点X以及该结点的所有孩子结点组成一个带头结点的单链表, 单链表的头结点含有两个域：数据域和指针域。其中, 数据域用于存储结点X中的数据元素, 指针域用于存储指向X第一个孩子结点的指针。
      　　![img](../../../static/img/02142/wpsE7EF.tmp.jpg)
     
2. 孩子兄弟链表表示法
     存储时每个结点除了数据域外, 还有**指向该结点的第一个孩子**和**下一个兄弟结点的指针**。

     结点结构如图4－14所示。
      　　![img](../../../static/img/02142/wpsE7F0.tmp.jpg)
     二叉链表中结点的左、右指针分别指向左、右孩子; 而孩子兄弟链表中结点的两个指针分别指向孩子和兄弟。
      　　![img](../../../static/img/02142/wpsE800.tmp.jpg)
...
3. 双亲表示法
     ...
     - 双亲域用于存储本结点的**双亲结点在数组中的序号** (下标值) 。
          ...
          图4－13a中树的双亲表示法如图4－16所示。
           　　![img](../../../static/img/02142/wpsE801.tmp.jpg)
...
1. **树转换为二叉树**
   ...
   3. **旋转**：
        ...
        - 以根结点为轴心按顺时针的方向旋转45°角。
             ![img](../../../static/img/02142/wps77AB.tmp.jpg)
...
2. **森林转换为二叉树**
   ...
   2. 将 (1) 中得到的各棵二叉树的根结点看作是兄弟连接起来。
      　　
        图4－18为森林转换到二叉树的过程。
        ![img](../../../static/img/02142/wps77AC.tmp.jpg)
         　　![img](../../../static/img/02142/wps77AD.tmp.jpg)
...
3. **二叉树转换为森林(还原)**
   ...
   2. **二叉树转换成树**
        - 将 step1 中得到的每一棵二叉树都**还原成树**(与树转换成二叉树的步骤刚好相反。)
             ![img](../../../static/img/02142/wps77AE.tmp.jpg)
              　　![img](../../../static/img/02142/wps77BF.tmp.jpg)
              　　![img](../../../static/img/02142/wps77C0.tmp.jpg)
              　　
...
- 用于描述分类过程的二叉树称为判定树。对上述分类问题可以画出两棵不同的判定树, 如图4－20所示。
  　　![img](../../../static/img/02142/wps1EF0.tmp.jpg)
...
- 一种最优的二叉树, 最优是指 WPL 最小!
  ...
  - 树的带权路径长度：
    ...
    ![image-20200922163445201](../../static/img/02142/image-20200922163445201.jpg)
...
- 我们来讨论如何构造一棵哈夫曼树, 
  ...
  2. $n$ 个权值分别设为 $w_1, w_2,  ... , w_n$ , 则哈夫曼树的构造规则为: 
       ...
       ![img](../../../static/img/02142/wps50BF.tmp.jpg)
...
- 【案例】设某通信系统中一个待传输的文本有 6 个不同字符, 它们的出现频率分别是 0.5, 0.8, 1.4, 2.2, 2.3, 2.8, 试设计哈夫曼编码。
  ...
  　　![img](../../../static/img/02142/wps50D0.tmp.jpg)
...
- 假如有这样一个问题：在N个城市间建立通信网络, 使得其中的任意两个城市之间有直接或间接的通信线路, 假设已知每两个城市之间通信线路的造价, 要求找出一个总造价最低的通讯网络。当N很大时, 这个问题十分复杂, 只能借助计算机来求解。
  　　![img](../../../static/img/02142/wps78A4.tmp.jpg)
    　　图5－1　用图描述的通信网络问题
    　　a) 初步方案G0　b) 最优方案G0'
...
- 无向完全图：**任何两点之间都有边的无向图**。
    ...
    - 一个具有 n 个顶点的无向完全图的**边数**为![img](../../../static/img/02142/wpsFBFE.tmp.jpg)。

- 有向完全图：**任何两点之间都有弧的有向图称为有向完全图**。

    - 一个具有 n 个顶点的有向完全图的**弧数**为![img](../../../static/img/02142/wpsFBFF.tmp.jpg)。
...
- **子图：**
    ...
    ![img](../../../static/img/02142/wpsFC00.tmp.jpg)
    　　图5－2　有向图和无向图示例
    　　a) G1　b) G2
    　　![img](../../../static/img/02142/wpsFC01.tmp.jpg)
    　　图5－3　G1的若干子图
    　　![img](../../../static/img/02142/wpsFC11.tmp.jpg)
    　　图5－4　G2的若干子图
  ...
  　　
    ...
    　　    - 图 5－5a 中存在多个不连通顶点。
        ...
        - **连通分量是无向图中的极大连通子图**。
            ...
            　　      　　![img](../../../static/img/02142/wpsFC12.tmp.jpg)
                        　　        　　图5-5　无向图及其连通分量示例
...
- **强连通、强连通图、强连通分量：**
  　　
    ...
    　　- **有向图的极大强连通子图称为强连通分量。**
      ...
      　　    图5－2a 的强连通分量如图5－6所示。
        　　![img](../../static/img/02142/wpsFC13.tmp.jpg)
...
- 生成森林：
  ...
  - 在非连通图中, 由每个连通分量都可得到一个**极小连通子图**, 即一棵生成树。
    - 那么这些连通分量的生成树就组成了一个非连通图的生成森林。
      　　  　　![img](../../../static/img/02142/wpsFC14.tmp.jpg)
        　　    　　图5－7　G2的一棵生成树
...
- 设 `G= (V, E) ` 是一个图, 其中 `V={V0, V1, …, Vn-1}`, 那么 G 的邻接矩阵 A 定义为如下的 n 阶方阵：
  　　$A[i][j]$=![img](../../../static/img/02142/wps59F1.tmp.jpg)

    ​	图5－2中有向图 G1 和无向图 G2 的邻接矩阵分别为 M1 和 M2 。
    　　![img](../../../static/img/02142/wps59F2.tmp.jpg)
...
- 用邻接矩阵也可以表示**带权图**(也称网), 只要令
  　　$A[i][j]$＝![img](../../../static/img/02142/wps5A03.tmp.jpg)

    　　图5－8给出一个带权图和它的邻接矩阵。
    　　![img](../../../static/img/02142/wps5A04.tmp.jpg)
    　　图5－8带权图及其邻接矩阵
...
- **邻接点域 (adjvex)** 和**链域 (nextarc)** , 
  - 在带权图的表结点中增加一个权值域, 用于存储边的**权值 (weight)** 。<img src="../../static/img/02142/image-20200922211626499.jpg" alt="image-20200922211626499"  />
...
- **无向图的邻接表**表示:
    ...
    - ![image-20200922212658557](../../../static/img/02142/image-20200922212658557.jpg)
    - 空间效率为 $O (n+2e)$ 。
...
- **有向图的邻接表**表示：
    ...
    - ![image-20200922213721433](../../static/img/02142/image-20200922213721433.jpg)
    - 空间效率为 $O (n+e)$
...
- 对于有向图, 有时需要建立一个逆邻接表, 即对每个顶点Vi建立一个以Vi为弧头的邻接点的链表。
  　　
    ...
    　　![img](../../../static/img/02142/wpsD68F.tmp.jpg)
        　　    　　图5－11　G1的邻接表和逆邻接表
        　　    　　a) 邻接表　b) 逆邻接表
...
- 同理, 我们可以给出 图5－1a 无向带权图的邻接表如 图5－12a 所示,
  　　
    -  图5－8a有向带权图的邻接表如 图5－12b 所示和 逆邻接表如 图5－12c 所示。
        　　![img](../../../static/img/02142/wpsD6A0.tmp.jpg)
    　　![img](../../../static/img/02142/wpsD6A1.tmp.jpg)
            　　图5－12　带权图的邻接表
...
- 深度优先搜索遍历算法思想: 采用堆栈
  ...
  3. 若与 i 有边相连的顶点都被访问过, 则退回到前一个访问顶点并重复刚才过程,直到图中所有顶点都被访问完止。
     ![img](../../../static/img/02142/wpsC984.tmp.jpg)
     　　　　　　　　　图5－13　深度优先搜索过程示例
...
- 连通图广度优先搜索的基本思想是：
  　　- 从图中某个顶点Vi出发, 在访问了Vi之后依次访问Vi的所有邻接点, 
    ...
    - 广度优先搜索遍历类似于树的按层次遍历的过程。
      　　![img](../../../static/img/02142/wpsC994.tmp.jpg)
        　　图5－14　广度优先搜索过程示意
...
- 如何生成树呢?
  ...
  - 深度优先(搜索)生成树、广度优先(搜索)生成树
    - ![image-20200922223213909](../../static/img/02142/image-20200922223213909.jpg)
    - ![image-20200922223135913](../../static/img/02142/image-20200922223135913.jpg)
...
- **普里姆(prim) 算法思想**: 
  ...
  - 举例: 选择开始顶点 1,求最小生成树
    - 首先U={1}, W={2, 3, 4, 5, 6}
    - ![image-20200922224348296](../../static/img/02142/image-20200922224348296.jpg)

- 第二种最小生成树算法: **克鲁斯卡尔( kruskal)**

  - 克鲁斯卡尔算法的基本思想是:
    - 将图中所有边按权值递增顺序排列, 依次选定取权值较小的边, 但要求面选取的边不能与前面选取的边构成回路, 若构成回路, 则放弃该条边, 再去选后面权值较大的边, n 个顶点的图中, 选够 n-1 条边即可。
  - ![image-20200922225823764](../../static/img/02142/image-20200922225823764.jpg)
...
- **单源点最短路径**：
  ...
  - ![image-20200922231117374](../../static/img/02142/image-20200922231117374.jpg)
...
1. 最小生成树的概念
   ...
   - 我们知道连通图的遍历序列不是唯一的, 所以能得到不同的生成树。
     ...
     图5－15为无向图G4的几棵生成树。
     　　![img](../../../static/img/02142/wpsEE89.tmp.jpg)
     　　图5－15　无向连通图G4的三棵生成树
...
2. 构造最小生成树的Prim算法
   ...
   3. 如果U=V, 则算法结束; 否则重复第 (2) 、 (3) 步。
      ...
      　　![img](../../../static/img/02142/wpsEE99.tmp.jpg)
...
3. 构造最小生成树的克鲁斯卡尔方法
   ...
   3. 依此类推, 重复 (2) , 直至T中所有顶点都在同一连通分量上为止。
      　　![img](../../../static/img/02142/wpsEE9A.tmp.jpg)
...
4. 单源最短路径
   ...
   4. 例如, 对图5－18中的有向图G5, 应用 Dijkstra 算法思想计算从源顶点v0到其他顶点间最短路径的过程列在表5－1中。
        ![img](../../../static/img/02142/wpsEE9B.tmp.jpg)
         　　图5－18　带权有向图G5
...
- 拓扑排序的步骤:
  ...
  ![image-20200922234524524](../../static/img/02142/image-20200922234524524.jpg)
...
　　![img](../../../static/img/02142/wpsD1D.tmp.jpg)
...
2. 拓扑排序
   ...
   3. 重复执行 (1) 、 (2) 直到所有入度为0的顶点均被输出, 拓扑排序完成, 或者图中再也没有入度为0的顶点。
      ...
      　　![img](../../../static/img/02142/wpsD1E.tmp.jpg)
      　　图5－20　求拓扑序列的过程
...
- 分块查找(块间有序, 块内无序)
  ...
  ![image-20200923153644695](../../static/img/02142/image-20200923153644695.jpg)
...
- 举例过程
  ...
  树过程如下图所示。
  - ![image-20200923103909058](../../static/img/02142/image-20200923103909058.jpg)
- [算法思想]二叉排序树
...
- 基本思想:
  ...
  ![image-20200923113738365](../../static/img/02142/image-20200923113738365.jpg)
...
- 具体实现的三种不同算法:
  ...
  - 直接插入排序(基于顺序查找)
    ...
    - ![image-20200924221734902](../../../static/img/02142/image-20200924221734902.png)

    - 监视哨

    - ![image-20200924214853357](../../static/img/02142/image-20200924214853357.jpg)
...
- ![image-20200924153129353](../../static/img/02142/image-20200924153129353.jpg)

- 例如，`n=8`， 数组 R 中的排序码为: `(8, 3, 2, 1, 7, 4, 6, 5)`，则直接选择排序
  过程

  ![image-20200924152809844](../../static/img/02142/image-20200924152809844.jpg)
...
- **大根堆 / 小根堆**: 最大堆 / 最小堆
  ...
  ![image-20200923181525414](../../static/img/02142/image-20200923181525414.jpg)

- ![image-20200923181840501](../../static/img/02142/image-20200923181840501.jpg)
...
- ![image-20200923182327522](../../static/img/02142/image-20200923182327522.jpg)
- 算法分析
  - 时间效率: $O (nlog_2n)$
  - 空间效率: $O (n)$
  - 稳定性:稳定
